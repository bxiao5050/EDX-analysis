...
def main():
    ...
    app = Distribution(ax = ax, canvas = canvas, x =x, y =y, deviation = deviation)
    Button(root, text = 'show in stage', command = app.on_showStage).pack()
    canvas.figure.canvas.mpl_connect('button_press_event', app.onclick_distribution)
